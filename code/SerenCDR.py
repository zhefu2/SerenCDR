...
for f in range(5):
  ...
  for epoch in range(EPOCHS):
      ...
      r = np.array([[train_loss.result(),  hr_1, hr_5, hr_10,  ndcg_5, ndcg_10]])
  ...
  col = ['Train_Loss', 'HR@1', 'HR@5', 'HR@10', 'NDCG@5', 'NDCG@10']
  df = pd.DataFrame(data=result, columns=col)
  df.to_csv('../Results/SerenCDR/CrossSeren_fold_%d.csv' % f)
