...
2. Train the SerernCDR model (The training data can be found [here](https://drive.google.com/drive/folders/1EDxFkNL2itTvaWLkL0TLjzehOip0AGgT?usp=sharing) (BERT encoder))
    ```
    python SerenCDR.py
    ```
